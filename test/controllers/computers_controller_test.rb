...
class ComputersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create computer" do
    assert_difference('Computer.count') do
      post computers_url, params: { computer: { city: @computer.city, model: @computer.model, name: @computer.name } }
    end
  ...
  test "should update computer" do
    patch computer_url(@computer), params: { computer: { city: @computer.city, model: @computer.model, name: @computer.name } }
